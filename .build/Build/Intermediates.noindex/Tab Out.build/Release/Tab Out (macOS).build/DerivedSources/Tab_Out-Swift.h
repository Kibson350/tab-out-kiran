...
#ifndef TAB_OUT_SWIFT_H
#define TAB_OUT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tab_Out",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7Tab_Out11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7Tab_Out14ViewController")
